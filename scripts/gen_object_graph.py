...
OBJ = {
 ...
 'offer':('Offer','Work Product',False),
 'experiment_strategy':('Experiment Strategy','Work Product',False),
 'campaign_strategy':('Campaign Strategy','Work Product',False),
 'journey_strategy':('Journey Strategy','Work Product',False),
...
ENVISIONED = [
 ...
 ('offer','product_context'),('offer','audience'),
 ('experiment_strategy','offer'),('experiment_strategy','campaign_strategy'),('experiment_strategy','creative_strategy'),
 ('campaign_strategy','marketing_strategy'),('campaign_strategy','audience'),('campaign_strategy','offer'),('campaign_strategy','journey_strategy'),
